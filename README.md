...
| Tab | Nombre | Estado |
|---|---|---|
| BI/R | Dashboard de inteligencia de negocio | ✅ Funcional — conectado a API real |
| Mapas | GIS interactivo | ✅ Funcional — Leaflet + PostGIS |
| Riego | Mi Riego — FAO-56 + Forecast 7 días | ✅ Funcional — BD + feedback + proyección Ridge Regression |
...
<sub>⚠️ Pre-MVP — Bloqueador principal: autenticación. PostGIS ✅ · Migraciones ✅ · Tests 83 ✅ · Loop feedback ✅ · Forecast 7d ✅ · BI real ✅</sub>
